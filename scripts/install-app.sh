...
ln -sf "warren-headless" "$cli_install_directory/warren-ghostline"
install -m 755 "$app_path/Contents/MacOS/warren-ssh-tunnel" "$cli_install_directory/warren-ssh-tunnel"
